      ...
      return function (r, p) {
              ...
              var w,
                ...
                O = u
                  ...
                  : l(
                      ...
                      E,
                      parseInt(
                        "function" == typeof a.offset ? a.offset() : a.offset,
                        10
                      )
                    ),
                I = O - v,
        ...
        var C = function (t) {
            if (
              ...
              var n = u(a(w.hash));
              if (g.topOnEmptyHash && -1 !== ["#", "#top"].indexOf(n))
                return t.preventDefault(), void A.animateScroll(0, w);
              (v = document.querySelector(n)),
                v && (t.preventDefault(), A.animateScroll(v, w));
            }
          },
          O = function (e) {
            if (
